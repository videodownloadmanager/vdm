...
public class Item {
    ...
    @Expose private StringProperty convertTo;
    ...
    @Expose private IntegerProperty intervalBetweenItems;
    ...
    public Item() {
        ...
        videoQuality = null;
        audioQuality = null;
        convertTo = new SimpleStringProperty();
        ...
        intervalBetweenItems = new SimpleIntegerProperty(0);
    ...
    public String toString() {
        ...
        return new StringBuilder("Item {")
                ...
                .append(", convertTo=").append(convertTo.get())
                ...
                .append(", intervalBetweenItems=").append(intervalBetweenItems.get())
    ...
    public int getIntervalBetweenItems() {
        return intervalBetweenItems.get();
    }

    public IntegerProperty intervalBetweenItemsProperty() {
        return intervalBetweenItems;
    }

    public void setIntervalBetweenItems(int intervalBetweenItems) {
        this.intervalBetweenItems.set(intervalBetweenItems);
    }
    ...
    private List<String> commandBuilder() {
        ...
        if (! getConvertTo().equals("None")) {
            List<String> convertToVideoFormats = Arrays.asList("mp4", "mkv", "avi", "webm", "flv", "ogg");
            List<String> convertToAudioFormats = Arrays.asList("mp3", "m4a", "wav", "aac");
            // if video
            if (convertToVideoFormats.contains(getConvertTo())) {
                cmdList.add("--recode-video");
                cmdList.add(getConvertTo());
            } else if (convertToAudioFormats.contains(getConvertTo())) {
                cmdList.add("-x");
        ...
        if (isPlaylist.getValue()) {
            ...
            if(intervalBetweenItems.get() > 0) {
                cmdList.add("--sleep-interval");
                cmdList.add(String.valueOf(intervalBetweenItems.get()));
            }
        } else {
