    ...
    private void infoBtnAction() {
        ...
        if( selectedItem != null) {
            ...
            try {
                ...
                infoWindowController.getConvertChoiceBox().getItems().add(selectedItem.getConvertTo());
                infoWindowController.getConvertChoiceBox().setValue(selectedItem.getConvertTo());
                infoWindowController.getConvertChoiceBox().setDisable(true);
                ...
                if(selectedItem.getIsPlaylist()) {
                    ...
                    infoWindowController.getIntervalSpinner().getEditor().setText(String.valueOf(selectedItem.getIntervalBetweenItems()));
                    infoWindowController.getIntervalSpinner().setDisable(true);
                } else {
